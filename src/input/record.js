...
;(function(NZJS) {
    ...
    function InputRecord(length) {
        ...
        this.epochTime = 0.0;               // The time epochState was recorded
    ...
    InputRecord.prototype.record = function(state, time) {
        ...
        var baseline = this.beginReplay().stateAt(time);
        ...
        // Insert the keyframe
        if (Object.keys(keyframe.deltas.button).length > 0 ||
            Object.keys(keyframe.deltas.axis).length > 0) {
